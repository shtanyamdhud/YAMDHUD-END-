...
def main_app():
    ...
    <div class="main-header">
        <h1>⚜️ YAMDHUD ⚜️</h1>
        <p>YAMDHUD END TO END SERVER SYSTEM </p>
    </div>
    """, unsafe_allow_html=True)
...
st.markdown('<div class="footer">⚜️YAMDHUD ON FREE⚜️WP+916399047686</div>', unsafe_allow_html=True)
